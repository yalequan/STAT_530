...
ODS RTF File="C:\Users\yaleq\desktop\Ch3_14.rtf"; *this will make a pdf output file;
ODS Listing Close;
Data Ch3_8;
input season score; /*1 = Summer, 2 = Sholder, 3 = Winter */
Datalines;
1 83
1 85
1 85
...
class season;
model score = season;
means season / hovtest tukey scheffe bon;
contrast 'season 1 vs 2' percent 1 -1 0;
contrast 'season 1 vs 3' percent 1 0 -1;
contrast 'season 2 vs 3' percent 0 1 -1;

estimate 'season 1 vs 2' percent 1 -1 0;
estimate 'season 1 vs 3' percent 1 0 -1;
estimate 'season 2 vs 3' percent 0 1 -1;
